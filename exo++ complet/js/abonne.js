...
let update_id = ''; // sauvegarde de l'id de l'abonné à modifier utilisé dans les deux fonctions Ajax qui suivent donc on le garde au chaud
let ligne_a_modifier = '';
...
$('.insert').on('click','.modifier', function(e) {
    ...
    $.post('controler.php', // URL du dossier où s'effectue le traitement
            ...
            function (infos) {  
				...
				$('#prenom_update').val(infos.prenom);	// on prépare les champs ùinput avec les valeurs à modifier
