...
function afficheEmprunt() {
    $.post ('controler.php',  // URL du dossier où s'effectue le traitement
...
let update_id = ''; // sauvegarde de l'id de l'emprunt à modifier utilisé dans les deux fonctions Ajax qui suivent donc on le garde au chaud
...
$('.insert').on('click','.modifier', function(e) {
    ...
    $.post('controler.php', // URL du dossier où s'effectue le traitement
            ...
            function (infos) {
            	...
            	updateFormulaire (infos.abonne_id, infos.livre_id); // on met à jour le formulaire en présélectionnant les champs correspondants
