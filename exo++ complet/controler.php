...
$managerAbonne = new AbonneManager();
...
$managerEmprunt = new EmpruntManager();
...
if(	isset($_POST['action']) && $_POST['action']=='ajout_emprunt' &&
	...
	$emprunt = new Emprunt( array( 'abonne_id' => $_POST['id_abonne'], 'livre_id' => $_POST['id_livre'], 'date_emprunt' => $_POST['date_emprunt'] ));
...
if(	isset($_POST['action']) && $_POST['action']=='modification_emprunt' &&
	...
	$emprunt = new Emprunt( array( 'id_emprunt' => $_POST['id_emprunt'], 'abonne_id' => $_POST['id_abonne'], 'livre_id' => $_POST['id_livre'], 'date_emprunt' => $_POST['date_emprunt'] ));
